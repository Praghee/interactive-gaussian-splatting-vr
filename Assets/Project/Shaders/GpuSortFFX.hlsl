...
// InteractiveGaussianSplattingVR — verbatim copy of AMD FidelityFX ParallelSort v1.1.1
// (via ninjamode/Unity-VR-Gaussian-Splatting). Buffer/constant/kernel names match
// GaussianSplatFfxSort.cs. Included by SplatSortFFX.compute.
// Copyright (c) 2023 Advanced Micro Devices, Inc. — MIT.
